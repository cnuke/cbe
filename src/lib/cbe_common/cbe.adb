...
is
   ...
   is (
      ...
      SB.State'Image &
      """ rk_vba=""" &
      Debug.To_String (Debug.Uint64_Type (SB.Rekeying_Curr_VBA)) &
      """>");
   ...
   begin
      ...
      Result.Rekeying_Curr_VBA       := Virtual_Block_Address_Type'First;
   ...
   begin
      ...
      Block_Data_From_Unsigned_64 (
         Data, Off, Unsigned_64 (SB.Rekeying_Curr_VBA));
      Off := Off + 8;
